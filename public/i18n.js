...
const EN = Object.freeze({
  ...
  "share.action": "Share an independent copy",
  "share.label": "Share",
  "share.copied": "Share link copied. Opening it creates an independent copy.",
  "share.imported": "The shared item was added to this session as an independent copy.",
  "share.opened": "This shared item was already added. The existing copy is now open.",
  "share.copyFailed": "Could not copy the share link. Check clipboard permission.",
  ...
  "menu.attachmentSub": "A BP or supporting materials; select multiple files when starting",
  ...
  "composer.note": "Use + to add multiple files when starting, or start company research; drag-and-drop is also supported · AI findings are for investment research only",
  ...
  "confirm.actionCancel": "Cancel",
  "confirm.actionOk": "Confirm",
  "followup.failed": "The follow-up request failed.",
  "apiError.generic": "The request failed. Please try again.",
  "apiError.offline": "Cannot reach the local service. Retry shortly or refresh the page.",
  "apiError.status": "Request failed ({status})",
  "apiError.activeTaskLimit": "You already have the maximum number of research tasks running. Wait for one to finish.",
  "apiError.cancelInProgress": "This research is still stopping. Try again shortly.",
  "apiError.cancelNotAllowed": "Only queued or running research can be stopped.",
  "apiError.companyNameRequired": "Company research needs a company name.",
  "apiError.companyResearchDisabled": "Company research is not enabled on this server.",
  "apiError.dailyBudgetExceeded": "Your daily research budget is used up. Try again tomorrow or contact the administrator.",
  "apiError.evidenceRefreshActive": "Public sources are being refreshed. Finish that first.",
  "apiError.evidenceRefreshDisabled": "Public source refresh is not enabled on this server.",
  "apiError.evidenceRefreshUnsupported": "This research type does not support refreshing public sources. Re-run the research or ask a follow-up instead.",
  "apiError.googleAuthRequired": "Sign in with a Google account to continue.",
  "apiError.industryTopicRequired": "Industry research needs an industry or technology topic.",
  "apiError.invalidJson": "The request body is not valid JSON.",
  "apiError.ownerRequired": "This browser session is invalid. Refresh the page.",
  "apiError.paperPdfOnly": "Paper analysis accepts PDF files only.",
  "apiError.paperSourceRequired": "Paper analysis needs a PDF upload or a paper URL.",
  "apiError.payloadTooLarge": "The request is too large.",
  "apiError.questionRequired": "Enter a question first.",
  "apiError.rateLimitExceeded": "Too many requests. Please slow down and retry.",
  "apiError.replaceBpUnsupported": "A company research conversation cannot take a replacement business plan. Start a new attachment review.",
  "apiError.reportNotReady": "The report is not ready yet.",
  "apiError.retryNotAllowed": "Only failed, needs-attention or stopped tasks can be retried.",
  "apiError.reviewNotFound": "That research task was not found.",
  "apiError.singleUploadOnly": "An existing conversation accepts only one new document at a time.",
  "apiError.sourceUploadMissing": "The original document is no longer stored. Upload it again to start a new review.",
  "apiError.taskAlreadyRunning": "This task is already running.",
  "apiError.taskQueueFull": "The research queue is full. Please submit again shortly.",
  "apiError.taskTypeDisabled": "That research task type is not enabled on this server.",
  "apiError.uploadCountExceeded": "You can upload at most 8 documents at once.",
  "apiError.uploadRequired": "Please upload a document first.",
  "apiError.uploadTooLarge": "The uploaded documents exceed the size limit.",
  ...
  "progress.taskStopped": "{task} stopped",
  "progress.taskResuming": "Resuming {task}",
  "cancel.action": "Stop research",
  "cancel.resume": "Resume research",
  "cancel.resuming": "Resuming…",
  "cancel.confirm": "Stop this research? Completed stages will be retained and you can resume later.",
  "cancel.done": "Research stopped. Completed stages were retained.",
  "cancel.resumed": "Research resumed from retained stages.",
  ...
  "validation.tooManyFiles": "You can upload up to 8 files when starting a review",
  "validation.totalFileSize": "All selected files must total 20 MB or less",
  "validation.fileRead": "The selected files could not be read",
